...
class WebServerStack(cdk.Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, vpc, **kwargs) -> None:
        ...
        web_server_asg = cdk.aws_autoscaling.AutoScalingGroup(
            self,
            "webServerAsgId",
            vpc=vpc,
        ...
        web_server_asg.connections.allow_from(alb, cdk.aws_ec2.Port.tcp(80), description="Allow ASG SG receive traffic from ALB")
